...
Шаг в конце слепка (`PlayerSexSyncService`): справочник singles + doubles (M/F), fallback из локальных дисциплин, затем участия из SSR-профиля (**все регионы**). Подробности — [`spike-parser.md`](spike-parser.md) §7, [`PLAN.md`](PLAN.md) этап 5.

Разовый прогон без слепка:
...
Покрытие на полном прогоне r77 (2026-07-23): **~97%** игроков с заполненным `sex`; без пола — в основном generic **D/XD** без MS/MD/WS/WD.
