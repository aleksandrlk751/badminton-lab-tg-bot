...
**Отложено (по плану):**
- Кнопки «H2H» и «История рейтинга» — заглушки (этапы 5 и 6).
...
- Навигация в одном сообщении: результаты поиска/карточка/соперники — через `EditMessageText`.
...
**Этап 5:** Bot — H2H для пар (см. §«Этап 5»). Каркас бота (поиск/карточка/соперники) готов,
