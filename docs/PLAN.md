...
**Отложено:**
- `PartnerScoreService` — **этап 6 ✓** (`s-ref-partner` в конфиге).
...
- Два блока («Уже играли» / «Новые кандидаты»), score §2.5; в «Уже играли» успешные за T мес. выше в сортировке.
...
**DoD:**
- [x] `PartnerScoreService` + конфиг `s-ref-partner`; unit-тесты.
